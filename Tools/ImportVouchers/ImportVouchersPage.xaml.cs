        ...
        async void CopyFiles(DirectoryInfo dirFrom)
        {
            ...
            foreach (var file in files)
            {
                try
                {
                    ...
                    if (lst.Count < 2)
                    {
                        _logs.AppendLogLine("File not correctly formattet");
                        continue;
                    }
                    ...
                    if (date == DateTime.MinValue)
                    {
                        _logs.AppendLogLine("Date not correctly formattet");
                        continue;
                    }
                    ...
                    if (idx >= 0)
                    {
                        ...
                        {
                            _logs.AppendLogLine("Voucher not correctly formattet");
                            continue;
                        }
