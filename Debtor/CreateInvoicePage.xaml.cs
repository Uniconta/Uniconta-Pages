...
namespace UnicontaClient.Pages.CustomPage
{
    public partial class CreateInvoicePage : GridBasePage
    {
        ...
        private void InitPage(UnicontaBaseEntity master, DebtorOrderLineClient[] orderLines = null)
        {
            ...
            cmbCreateAccount.ItemsSource = new string[] { string.Format(Uniconta.ClientTools.Localization.lookup("CreateOBJ"), Uniconta.ClientTools.Localization.lookup("Debtor")), Uniconta.ClientTools.Localization.lookup("OneTimeDebtor") };
            cmbCreateAccount.ToolTip = string.Format(Uniconta.ClientTools.Localization.lookup("CreateOBJ"), Uniconta.ClientTools.Localization.lookup("Debtor"));
        ...
        public override async void Utility_Refresh(string screenName, object argument)
        {
            ...
            if (screenName == TabControls.DebtorAccountPage2 && argument != null)
            {
        ...
        async Task CreateOrderFromInvoice(DebtorOrderClient order, DebtorInvoiceClient invoice, bool checkIfCreditNote)
        {
            ...
            Order.DeliveryPhone = invoice.DeliveryPhone;
            Order.DeliveryContactPerson = invoice.DeliveryContactPerson;
            Order.DeliveryContactEmail = invoice.DeliveryContactEmail;

            order.CompanyAddress = invoice._CompanyAddress;
        ...
        void ClearFields(UnicontaBaseEntity master = null)
        {
        ...
        void CopyFromDebtor(Debtor debtor)
        {
            if (debtor == null)
                return;
            ...
            Order.DeliveryPhone = debtor._Phone;
            Order.DeliveryContactPerson = debtor._ContactPerson;
            Order.DeliveryContactEmail = debtor._ContactEmail;
        ...
        protected override async System.Threading.Tasks.Task LoadCacheInBackGroundAsync()
        {
            ...
            var UserEmp = EmployeeClient.GetUserEmployee(api);
            if (UserEmp != null && Order._Employee == null)
            {
                Order._Employee = UserEmp._Number;
                initialOrder._Employee = UserEmp._Number;
                if (Order._Dim1 == null) Order._Dim1 = UserEmp._Dim1;
                if (Order._Dim2 == null) Order._Dim2 = UserEmp._Dim2;
                if (Order._Dim3 == null) Order._Dim3 = UserEmp._Dim3;
                if (Order._Dim4 == null) Order._Dim4 = UserEmp._Dim4;
                if (Order._Dim5 == null) Order._Dim5 = UserEmp._Dim5;
            }
            ...
            if (Comp.Warehouse)
            {
                ...
                userWarehouse = UserEmp?._Warehouse;
            }
        ...
        private void cmbCreateAccount_SelectedIndexChanged(object sender, RoutedEventArgs e)
        {
            ...
            if (cmbCreateAccount.SelectedIndex == 1)
            {
                if (Order.OneTimeDebtor == null)
                    Order.OneTimeDebtor = Activator.CreateInstance(api.CompanyEntity.GetUserType(typeof(DebtorClient))) as DebtorClient;
        ...
        void AttachDocuments()
        {
            ...
            if (documents?.Count > 0)
            {
                ...
                attachDocMenu.Caption = Util.ConcatParenthesis(string.Format(Uniconta.ClientTools.Localization.lookup("AttachOBJ"), Uniconta.ClientTools.Localization.lookup("Documents")), documents.Count);
            }
        }
