...
{
    public class BankdataSystemtestServiceProvider : TestServiceProvider
    {
        public override X509Certificate2 RootCaCertificate
            => FromPemBlock("MIIFpzCCA4+gAwIBAgIBADANBgkqhkiG9w0BAQsFADB1MScwJQYDVQQDEx5CRCBC" +
        ...
        public override string RegistrationNumber => "8079"; //Regnr for you bank. 8079 is Sydbank
    }
}